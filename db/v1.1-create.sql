...
--
-- Host: localhost
-- Generation Time: Aug 28, 2017 at 03:32 PM
...
--
-- Table structure for table `dov_settings`
--

CREATE TABLE IF NOT EXISTS `dov_settings` (
`id` int(11) NOT NULL,
...
--
-- Indexes for table `dov_settings`
--
ALTER TABLE `dov_settings`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `dov_settings`
--
ALTER TABLE `dov_settings`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
